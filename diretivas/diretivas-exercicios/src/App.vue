<template>
	<div id="app">
		...
		<p v-destaque="color">Usando diretiva personalizada</p>

		<p v-destaque-local:fundo.atrasar.alternar="{cor1: 'green', cor2: 'red', atraso: 2000, intervalo: 200}">Usando diretiva personalizada</p>
		<p v-destaque-local.alternar="{cor1: 'green', atraso: 500}">Usando diretiva personalizada</p>
		<!-- Anatomia de uma diretiva -->
		<!-- <p v-teste:argumento.modificador1.modificador2="'valor'"></p> -->
	</div>
</template>
